...
// TODO think of Close() function which destroys Codegen instance?
...
// ErrGetSnippet is an error when some snippet is not found
var ErrGetSnippet = errors.New("Snippet with such key not found")

// ErrGetGenerator is an error when some generator function is not found
...
// RegisterDefaultGenerators registers non-exporting generation functions from package
